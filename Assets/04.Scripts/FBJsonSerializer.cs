...
public class FBJsonSerializer
{
	...
	protected static Hashtable ParseObject( char[] json, ref int index, ref bool success )
	{
		...
		while( !done )
		{
			...
			if( token == FBJsonSerializer.TOKEN_NONE )
			{
				success = false;
				return null;
			}
			else if( token == FBJsonSerializer.TOKEN_COMMA )
			{
				NextToken( json, ref index );
			}
			else if( token == FBJsonSerializer.TOKEN_CURLY_CLOSE )
			{
				NextToken( json, ref index );
				return table;
			}
			else
			{
				...
				if( token != FBJsonSerializer.TOKEN_COLON )
				{
					success = false;
					return null;
				}
	...
	protected static ArrayList ParseArray( char[] json, ref int index, ref bool success )
	{
		...
		while( !done )
		{
			...
			else if( token == FBJsonSerializer.TOKEN_SQUARED_CLOSE )
			{
				NextToken( json, ref index );
				break;
			}
	...
	protected static object ParseValue( char[] json, ref int index, ref bool success )
	{
		...
		{
			case FBJsonSerializer.TOKEN_STRING:
				return ParseString( json, ref index, ref success );
			case FBJsonSerializer.TOKEN_NUMBER:
				return ParseNumber( json, ref index, ref success );
			case FBJsonSerializer.TOKEN_CURLY_OPEN:
				return ParseObject( json, ref index, ref success );
			case FBJsonSerializer.TOKEN_SQUARED_OPEN:
				return ParseArray( json, ref index, ref success );
			case FBJsonSerializer.TOKEN_TRUE:
				NextToken( json, ref index );
				return true;
			case FBJsonSerializer.TOKEN_FALSE:
				NextToken( json, ref index );
				return false;
			case FBJsonSerializer.TOKEN_NULL:
				NextToken( json, ref index );
				return null;
			case FBJsonSerializer.TOKEN_NONE:
				break;
		}
	...
	protected static int NextToken( char[] json, ref int index )
	{
		...
		if( index == json.Length )
		{
			return FBJsonSerializer.TOKEN_NONE;
		}
		...
		{
			case '{':
				return FBJsonSerializer.TOKEN_CURLY_OPEN;
			case '}':
				return FBJsonSerializer.TOKEN_CURLY_CLOSE;
			case '[':
				return FBJsonSerializer.TOKEN_SQUARED_OPEN;
			case ']':
				return FBJsonSerializer.TOKEN_SQUARED_CLOSE;
			case ',':
				return FBJsonSerializer.TOKEN_COMMA;
			case '"':
				return FBJsonSerializer.TOKEN_STRING;
			case '0':
			case '1':
			case '2':
			case '3':
			...
			case '9':
			case '-':
				return FBJsonSerializer.TOKEN_NUMBER;
			case ':':
				return FBJsonSerializer.TOKEN_COLON;
		}
		index--;
		...
		if( remainingLength >= 5 )
		{
			...
			{
				index += 5;
				return FBJsonSerializer.TOKEN_FALSE;
			}
		}
		...
		if( remainingLength >= 4 )
		{
			...
			{
				index += 4;
				return FBJsonSerializer.TOKEN_TRUE;
			}
		}
		...
		if( remainingLength >= 4 )
		{
			...
			{
				index += 4;
				return FBJsonSerializer.TOKEN_NULL;
			}
		}
