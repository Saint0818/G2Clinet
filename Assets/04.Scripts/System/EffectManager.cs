...
public class EffectManager : MonoBehaviour
{
	...
	{
		string[] strs = new string[]{"FX_SelectDown","SelectMe", "SelectA", "SelectB", "MoveTo", "BallHolder", "SkillSign", "SkillSign01", "PassMe", "PassA", "PassB", "UseSkillEffect_0", "SkillSign1", "SkillSign2", "SkillSign101", "SkillSign201"};
