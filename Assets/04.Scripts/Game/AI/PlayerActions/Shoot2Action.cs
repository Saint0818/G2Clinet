...
namespace AI
{
    public class Shoot2Action : PlayerAIAction
    {
        public Shoot2Action(PlayerAI playerAI, PlayerBehaviour player) : base(playerAI, player)
        {
        }

        public override float Probability
        {
            get { return Player.Attr.ShootingRate + Player.Attr.PointRate2; }
        }
