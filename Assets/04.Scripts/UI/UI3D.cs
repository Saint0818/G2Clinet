...
//				UIPlayerShow.Get.gameObject.transform.localEulerAngles = Vector3.zero;
			...
			case UIKind.GameResult:
				...
				gameObject.transform.position = CameraMgr.Inst.uiCam.transform.position;
				gameObject.transform.eulerAngles = CameraMgr.Inst.uiCam.transform.eulerAngles;
				break;
		}
	}

	public void SetFocusLastShooter(GameObject shooter)
	{
		if (shooter) 
		{
			followTime = 2;
