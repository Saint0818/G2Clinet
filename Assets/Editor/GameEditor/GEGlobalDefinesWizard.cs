...
public class GEGlobalDefinesWizard : ScriptableWizard
{
	[System.Serializable]
	...
	public static void CreateWizardFromMenu()
	{
		var helper = ScriptableWizard.DisplayWizard<GEGlobalDefinesWizard>( "Global Defines Manager", "Save", "Cancel" );
